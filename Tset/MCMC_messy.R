...
for(iter in seq(iter, n_iterations_update)){
 ...
 ####  abline(a=0, b=1)
  ...
  #      new_noise =variance_field(beta = new_noise_beta, hierarchical_model$noise$PP, 
  #                                use_PP = hierarchical_model$noise_PP, X = covariates$noise_X$X, 
  #                                locs_idx = NULL)
  #      ll_ratio = (
  #        -.5* sum(log(new_noise)) 
