...
set.seed(123)
mise_a_jour_mcmc_parallele2 = run_parallel_version_goret(
  object = gnsDemo, n_chains_in_parallel = 1,
  n_threads_per_chain = 6, n_iterations = 15, seed = 1)
...
set.seed(123)
mise_a_jour_mcmc_parallele3 = run_parallel_version_goret(
  object = gnsDemo, n_chains_in_parallel = 3,
  n_threads_per_chain = 6, n_iterations = 15, seed = 1)

set.seed(123)
mise_a_jour_mcmc_parallele4 = run_parallel_version_goret(
  object = gnsDemo, n_chains_in_parallel = 3,
  n_threads_per_chain = 6, n_iterations = 15, seed = 1)
