...
test_that("createVecchia works", {
  ...
  expect_named(res, c(
    "n_locs", "n_obs", "observed_locs", "locs", "t_locs",
...
test_that("process_covariates work as expected", {
  ...
  expect_true(is(res, "list"))
  expect_named(res, c(
    "arg", "X", "chol_crossprod_X", "n_regressors",
...
test_that("initialize class GeoNonStat works", {
  ...
  expect_named(myobj, c(
    "covariates", "observed_field",
  ...
  # hierarchical_model
  expect_named(myobj$hierarchical_model, c(
